...
HD_PWD='C:/Users/240689/ARM_demo/ARM_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rp_zynq_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rp_zynq_wrapper.tcl -notrace
