...
HD_PWD='C:/Users/240689/ARM_demo/ARM_demo.runs/rp_zynq_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rp_zynq_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rp_zynq_processing_system7_0_0.tcl
