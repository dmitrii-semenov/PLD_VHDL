...
HD_PWD='C:/Users/240689/VIO_ILA/VIO_ILA.runs/VIO_LED_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VIO_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VIO_LED.tcl
