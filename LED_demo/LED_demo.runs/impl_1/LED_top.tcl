...
namespace eval ::optrace {
  variable script "P:/PLD_VHDL/LED_demo/LED_demo.runs/impl_1/LED_top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir P:/PLD_VHDL/LED_demo/LED_demo.cache/wt [current_project]
  set_property parent.project_path P:/PLD_VHDL/LED_demo/LED_demo.xpr [current_project]
  set_property ip_output_repo P:/PLD_VHDL/LED_demo/LED_demo.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet P:/PLD_VHDL/LED_demo/LED_demo.runs/synth_1/LED_top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc P:/PLD_VHDL/LED_demo/sources/RP_top.xdc
OPTRACE "read constraints: implementation" END { }
OPTRACE "add files" END { }
OPTRACE "link_design" START { }
  link_design -top LED_top -part xc7z010clg400-1 
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force LED_top_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file LED_top_timing_summary_routed.rpt -pb LED_top_timing_summary_routed.pb -rpx LED_top_timing_summary_routed.rpx -warn_on_violation "
...
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force -no_partial_mmi LED_top.mmi }
